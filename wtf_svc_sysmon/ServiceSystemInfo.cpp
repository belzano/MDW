...
ServiceSystemInfo::ServiceSystemInfo() : WTF::ServiceTemplate<ServiceSystemInfo>()
{
    //string sysinfoparams[] = {"cpus", "memory", "os"}; 
	//_serviceParams = set<string>(sysinfoparams, sysinfoparams + 3);
}

bool ServiceSystemInfo::process(const std::string ,
						 const std::map<std::string, std::string>& , 			 
						 const std::map<std::string, toolbox::DataPtr>& ,
						 toolbox::DataPtr& reply)
{
	/*
